...
export ARCH=arm
export CROSS_COMPILE=/home/basile/Android/Kernel/toolchains/arm-cortex_a15-linux-gnueabihf-linaro_4.9.1-2014.04/bin/arm-cortex_a15-linux-gnueabihf- # path to your toolchain
export KBUILD_BUILD_USER=pec0ra # Name of the user who will appear in kernel information
export KERNELS_PATH=~/Android/Kernel/kernels # The path where you have your kernel sources (each different kernel in another subdirectory)
export PACKING_PATH=~/Android/Kernel/build_tools/msm8974ab_shinano # The path to DooMLoRD's build tool
export FINALS_PATH=~/Android/Kernel/final # The path where you will create your zip files (each different kernel in another subdirectory)
